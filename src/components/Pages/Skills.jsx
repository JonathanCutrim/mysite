      ...
      <div className="px-6 py-8 md:px-12 md:py-10 relative z-20 w-full">
        ...
        <header className="mb-16">
          ...
          >
            ...
            >
              Desenvolvedor Front-End, com um pé no Back e coração nos Jogos
            </GlitchText>
          </h2>
...
<p className={`bio-paragraph bio-paragraph-1 ${getTextColor('paragraph')}`}>
  <span className="font-semibold">Especialista em desenvolvimento front-end</span> com extenso histórico em projetos de e-commerce, com mais de  
  <CountUp
    from={0}
    to={50}
    separator=","
  ...
  />
projetos entregues anpenas em vtex.
